  ...
  */
  ...
  {  
	  ...
	  if(document.getElementById("txtUser").value.length < 3 ||document.getElementById("txtUser").value.length > 18 )
	  {
	 		 //设置id为tips_username的<span>的HTML，显示错误信息
			 document.getElementById("tips_username").innerHTML = "<em style='color:#FF0000'>用户名由3-18个字符组成</em>";
			 return false;
	  }
	  else
	  {
	  ...
	  //检查学校是否输入
	  if(document.getElementById("txtSch").value.length <1 )
	  {
			 document.getElementById("tips_usersch").innerHTML = "<em style='color:#FF0000'>请填写学校</em>";
			 return false;
	  }
	  else
	  {
			document.getElementById("tips_usersch").innerHTML ="OK！";	
	  }
	  ...
	  //检查年级是否为空
	  if(document.getElementById("txtGrade").value.length < 0)
	  {
			 document.getElementById("tips_usergrade").innerHTML = "<em style='color:#FF0000'>年级必须填写</em>";
			 return false;
	  }
	  else
	  {
			document.getElementById("tips_usergrade").innerHTML ="OK！";	
	  }
