<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"
    import="xiao.utils.DbUtil,java.sql.*"
    %>
<!DOCTYPE html>
<html>
<head>
...
<%
	...
	String usersch = request.getParameter("usersch");
	...
	//编写SQL语句
	String sql = "INSERT INTO atb_users(fd_username,fd_password,fd_usersch,fd_usertype,fd_gender,fd_email," +
			"fd_birthdate, fd_usergrade,fd_introduction,fd_hobby) VALUES (?,?,?,?,?,?,?,?,?,?)";
	...
	ps.setString(3, usersch);
	ps.setString(4, usertype);
	ps.setString(5, gender);
	ps.setString(6, email);
	ps.setString(7, birthdate);
	ps.setString(8, usergrade);
	...
	if(result >0 )
	{
		...
		while(rs.next())
		{
			...
			sb.append("</td><td>");
			sb.append(rs.getString("fd_usersch"));
			sb.append("</td><td>");
			sb.append(rs.getString("fd_usergrade"));
			sb.append("</td><td>");
